...
const DoctorCard = ({ name, speciality, experience, ratings, profilePic }) => {
  ...
  useEffect(() => {
    const tempAppointment = localStorage.getItem('doctorData');

    if (tempAppointment) {
      const updatedAppointments = [JSON.parse(tempAppointment)];
  ...
  const handleCancel = (appointmentId) => {
    ...
    // Always save the updated appointments array to localStorage
